...
blockdecl: (arraydecl|vardecl) SEMI; //all of them
...
instanceattributeaccess: (ID|THIS|IO) DOT ID;
staticattributeaccess: ID DOT ID;
instancemethodinvocation: (ID|THIS|IO) DOT ID LB listexpression RB;
...
literal: INTLIT | FLOATLIT | BOOLIT | STRINGLIT;
...
arraydecl: arraytype LSB INTLIT RSB idlist;
...
typ: INTTYPE|FLOATYPE|BOOLEANTYPE|STRINGTYPE|VOIDTYPE;
INTTYPE:'int';
FLOATYPE: 'float';
BOOLEANTYPE: 'boolean';
STRINGTYPE:'string';

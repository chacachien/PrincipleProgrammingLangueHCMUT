...
instanceattributeaccess: expression DOT ID; //(ID|THIS|IO)
...
exp8: exp9 LSB expression RSB | exp9 ; //|NIL; //test later
...
exp11: LB expression RB | ID | THIS |IO| literal | NIL;
...
THEN: 'then'; FOR: 'for'; RETURN: 'return';
